  ...
  return (
    ...
    >
       ...
       <div className="w-full md:w-5/12 pl-8 md:pl-0">
          <div className={`bg-theme-panel p-6 border border-theme-border shadow-[8px_8px_0px_0px_var(--color-border)] hover:translate-x-1 hover:-translate-y-1 transition-transform ${index % 2 === 0 ? 'md:text-right' : ''}`}>
             <span className="font-mono text-xs text-theme-bg bg-theme-text px-2 py-1 mb-2 inline-block">{year}</span>
             <h4 className="text-xl font-bold mb-2">{title}</h4>
             <p className="font-mono text-xs opacity-70 leading-relaxed">{desc}</p>
          </div>
       </div>
    </motion.div>
  );
    ...
    >
      ...
      <div className="container mx-auto px-8 md:px-32 relative z-10">
         ...
         <div className="relative py-12">
            ...
            {/* Vertical Line */}
            <div className="absolute left-4 md:left-1/2 top-32 bottom-0 w-[2px] bg-theme-border/10 -translate-x-1/2">
               <motion.div 
            ...
            <div className="flex justify-center relative mt-12">
               <div className="bg-theme-text text-theme-bg px-8 py-4 font-mono uppercase tracking-widest text-xs animate-pulse">
                  Awaiting Next Input...
               </div>
            </div>
         </div>
