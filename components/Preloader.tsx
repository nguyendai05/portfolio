...
export const Preloader: React.FC<PreloaderProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    const completeTimeout = setTimeout(() => {
      setCount(100);
      setTimeout(onComplete, 800); // Delay to let 100% sink in
    }, duration);
           ...
           <div className="overflow-hidden">
             ...
             >
               ...
               <div className="flex items-center gap-3 mt-2 ml-1">
                  <span className="w-2 h-2 bg-mantis-green rounded-full animate-pulse shadow-[0_0_10px_rgba(57,255,20,0.6)]"></span>
                  <span className="text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] opacity-60">Dev Portfolio</span>
               </div>
             </motion.div>
           </div>
