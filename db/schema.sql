...
INSERT INTO projects (slug, title, summary, description, category, project_type, image_url, link, featured) VALUES 
  (
    ...
    'Full-Stack Platform',
    'project',
    'https://api.microlink.io/?url=https%3A%2F%2Fhub.nguyenxuandai.com&screenshot=true&embed=screenshot.url',
  ...
  (
    ...
    'Streaming Platform',
    'project',
    'https://api.microlink.io/?url=https%3A%2F%2Fmuphim.online&screenshot=true&embed=screenshot.url',
  ...
  (
    ...
    'project',
    'https://api.microlink.io/?url=https%3A%2F%2Fnuoi.nguyenxuandai.com&screenshot=true&embed=screenshot.url',
